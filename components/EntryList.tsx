    ...
    <div className="w-full h-full flex flex-col bg-diary-paper p-6 sm:p-8">
      <div className="mb-6 pb-4 border-b-2 border-diary-accent">
        ...
        <div className="flex justify-between items-center mb-4">
          <button onClick={onCloseDiary} className="text-diary-accent font-bold hover:underline flex items-center gap-1 text-sm">
          ...
          <div className="flex items-center gap-2">
            <button onClick={onExport} title="Export entries to PDF" className="p-2 bg-diary-bg text-diary-dark rounded-md shadow-sm border border-diary-accent hover:bg-diary-accent/20 transition-all duration-200">
            ...
            {userRole === 'author' && (
              <>
                <button
                    ...
                    className="px-3 py-2 bg-diary-bg text-diary-dark font-bold font-sans rounded-md shadow-sm border border-diary-accent hover:bg-diary-accent/20 transition-all duration-200 flex items-center gap-2"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
